...
export const FileManager = ({
  ...
  return (
    <CssReset>
      ...
      >
        <Typography variant="caption" fontSize="medium" flex={1}>
          Bucket ID
        </Typography>
        <Typography variant="caption" fontSize="medium" flex={1} textAlign="right">
          Used Storage
        </Typography>
        <Typography variant="caption" fontSize="medium" flex={1} textAlign="center">
          ACL
        </Typography>
        <Box flex={1}></Box>
      </StyledBox>
