...
// Styled components
const MatrixContainer = styled(Container)(({ theme }) => ({
...
const TypedTerminal: React.FC<TypedTerminalProps> = ({ text, speed = 50 }) => {
  ...
  return (
    <Box sx={{ fontFamily: '"Share Tech Mono", monospace', color: matrixGreen, whiteSpace: 'pre-wrap' }}>
      {displayedText}
    ...
    <>
      ...
      <MatrixContainer maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          <pre style={{ color: matrixGreen, margin: '0 auto', fontFamily: '"Share Tech Mono", monospace' }}>
            {asciiArt}
          </pre>
