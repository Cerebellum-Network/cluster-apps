 ...
 */
export const APP_ID = import.meta.env.VITE_NODE_PROVIDER_APP_ID || 'node-provider';
export const APP_NAME = import.meta.env.VITE_NODE_PROVIDER_APP_NAME || 'Node Provider';
